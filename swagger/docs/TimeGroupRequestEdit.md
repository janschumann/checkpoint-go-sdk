...
**Members** | [***Add**](add.md) |  | [optional] [default to null]
**Name** | **string** | Object name. | [optional] [default to null]
**NewName** | **string** | New name of the Time Group. Cannot be more than 11 characters. Should be unique in the domain. | [optional] [default to null]

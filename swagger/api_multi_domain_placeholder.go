...
/*
MultiDomainPlaceholderApiService
...
func (a *MultiDomainPlaceholderApiService) ShowPlaceHolderPost(ctx context.Context, apiPlaceHolderIdentifierRequest ApiPlaceHolderIdentifierRequest) (ApiPlaceHolderReply, *http.Response, error) {
	var (
		...
		localVarReturnValue ApiPlaceHolderReply
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/show-place-holder"
	...
	// body params
	localVarPostBody = &apiPlaceHolderIdentifierRequest
	if ctx != nil {

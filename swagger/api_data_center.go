...
func (a *DataCenterApiService) ShowDataCenterContentPost(ctx context.Context, dataCenterContentRequest DataCenterContentRequest) (DataCenterContentQueryReply, *http.Response, error) {
	var (
		...
		localVarReturnValue DataCenterContentQueryReply
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/show-data-center-content"
	...
	// body params
	localVarPostBody = &dataCenterContentRequest
	if ctx != nil {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DataCenterContentQueryReply

...
func (a *PolicyApiService) InstallPolicyPost(ctx context.Context, policyInstallationRequest PolicyInstallationRequest) (PolicyInstallationReply, *http.Response, error) {
	var (
		...
		localVarReturnValue PolicyInstallationReply
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/install-policy"
	...
	// body params
	localVarPostBody = &policyInstallationRequest
	if ctx != nil {
...
func (a *PolicyApiService) VerifyPolicyPost(ctx context.Context, verifyPolicyRequest VerifyPolicyRequest) (VerifyPolicyReply, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VerifyPolicyReply
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/verify-policy"
	...
	// body params
	localVarPostBody = &verifyPolicyRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
